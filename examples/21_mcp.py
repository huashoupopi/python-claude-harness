...
def spawn_teammate_thread(name: str, role: str, prompt: str) -> str:
    ...
    def run():
        ...
        sub_tool_registry = {
            "bash": ("Run a shell command.", BashArgs, _run_bash),
            "send_message": (
                ...
                for tc in msg.tool_calls:
                    ...
                    if not entry:
                        ...
                        try:
                            ...
                            output = (
                                f"Error: invalid arguments for {tc.function.name}: {e}"
                            )
                        else:
        ...
        tool_defs=[
            {
                ...
                "inputSchema": SearchDocsArgs,
            },
            {
                "name": "get_version",
                "description": "Get API version. (readOnly)",
                "inputSchema": NoneArgs,
            },
        ],
        handlers={
...
def assemble_tools():
    ...
    TOOLS = [
        ...
        for name, (desc, args_model, _) in TOOLS_Registry.items()
    ]
